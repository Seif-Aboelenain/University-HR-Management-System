<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LastMonthPayroll.aspx.cs" Inherits="databasemile3.Academic.LastMonthPayroll" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <asp:Button ID="btnLoadPayroll" runat="server" Text="Load Payroll" CssClass="dark-btn" OnClick="btnLoadPayroll_Click" />
 <br /><br />

 <asp:GridView ID="gvPayroll" runat="server" AutoGenerateColumns="true" CssClass="grid-dark"></asp:GridView>

 <asp:Label ID="lblPayrollMsg" runat="server" ForeColor="LightGray"></asp:Label>
 </div>
</asp:Content>
