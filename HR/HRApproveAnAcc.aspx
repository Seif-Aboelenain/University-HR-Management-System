<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRApproveAnAcc.aspx.cs" Inherits="databasemile3.HR.HRApproveAnAcc" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>HR - Approve Annual/Accidental Leave</title>
    ...
    <div class="page-wrapper">
        <div class="dashboard">
            ...
            <div class="dash-header">
                <h1 class="dash-title">Approve / Reject Leave Requests</h1>
                <p class="dash-subtitle">Manage Annual and Accidental Leave Requests submitted by employees.</p>
                <span class="chip">HR • Leave Management</span>
            </div>

            <div class="grid">
                <asp:GridView ID="gvRequests" runat="server" AutoGenerateColumns="False" DataKeyNames="request_ID">
                    <Columns>
