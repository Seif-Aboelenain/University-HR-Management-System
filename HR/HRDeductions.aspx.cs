        ...
        private void LoadPendingDeductions()
        {
            ...
            using (SqlConnection conn = new SqlConnection(cs))
            {
                ...
                string query = @"
                    ...
                    WHERE d.type = 'missinghours' AND d.status = 'pending'
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(cs))
                {
                    ...
                    using (SqlCommand checkCmd = new SqlCommand(
                        "SELECT COUNT(*) FROM Employee WHERE emp_ID = @id", conn))
                    {
                ...
                lblResult.Text = "Missing hours deduction processed successfully.";
                txtEmpId.Text = "";  
                LoadPendingDeductions();
            }
            catch (Exception ex)
