<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApproveAnnualLeaves.aspx.cs" Inherits="databasemile3.Academic2.ApproveAnnualLeaves" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 .form-wrapper{ max-width:550px; margin:60px auto; padding:020px }
 ...
 <div class="form-card">
 <h2 class="form-title">Approve / Reject Annual Leave</h2>
 <p class="form-desc">Enter the annual leave request ID and the replacement employee ID.</p>

 <div class="form-row">
 <span class="form-label">Annual Leave Request ID</span>
 <asp:TextBox ID="txtRequestId" runat="server" CssClass="form-input" />
 </div>

 <div class="form-row">
 <span class="form-label">Replacement Employee ID</span>
 <asp:TextBox ID="txtReplacementId" runat="server" CssClass="form-input" />
 </div>

 <asp:Button ID="btnProcessAnnual" runat="server" Text="Process (Approve / Reject)" CssClass="form-btn" OnClick="btnProcessAnnual_Click" />
